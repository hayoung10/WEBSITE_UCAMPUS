            ...
            <div class="form-group">
             ...
             <div class="form-group" style="text-align:center;">
                <div class="btn-group" data-toggle="buttons">
					...
					<input type="radio" autocomplete="off" value="Software" name="deName">Software
					</label>
			
	                <label class="btn btn-default">
					<input type="radio" autocomplete="off" value="ComputerScience" name="deName">ComputerScience
					</label>
				</div>
			</div>
		<div class="container">
            ...
            <div class="form-group"  style="text-align:center;">
                <label class="btn btn-default" >
					 <input type="checkbox" autocomplete="off" name="sec1" value="aSubject">aSubject
				</label>
		
                <label class="btn btn-default">
					 <input type="checkbox" autocomplete="off" name="sec2" value="bSubject">bSubject
				</label>
			
                <label class="btn btn-default">
					 <input type="checkbox" autocomplete="off" name="sec3" value="dSubject">dSubject
				</label>
