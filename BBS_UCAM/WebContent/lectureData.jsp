                  ...
                  <form method="post" action="lectureData.jsp">
                     <tr>
                        ...
                        <td width="400" colspan="5"style="text-align:right"><select class="" name="sem">
                              ...
                              %> <%
                                  if (secStuList.get(i).getSecName().equals("aSubject")) {
                               %><option value="aSubject">
                                    <%
                                    } else if (secStuList.get(i).getSecName().equals("bSubject")) {
                                 %>
                                 
                                 <option value="bSubject">
                                    <%
                                    } else if (secStuList.get(i).getSecName().equals("dSubject")) {
                                 %>
