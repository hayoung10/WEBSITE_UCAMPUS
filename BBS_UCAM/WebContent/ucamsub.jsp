...
<body>
    ...
    <%
        ...
        System.out.println("section 값은? : "+ sectionName);
        ...
        <div id="content_wrap">
            <div id="detail_list">
                <table class="table table-bordered">
                    <tbody>
                        <form action="uploadAction.jsp" enctype="multipart/form-data" method="post">
                            
                                <th>해당 첨부파일 설명</th>
                                <td><textarea cols="10" placeholder="내용을 입력하세요. "
                                        name="text" class="form-control" style="height: 500px;"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>첨부파일:</th>
                                <td><input type="file"
                                    name="file1"> <input type="file"
                                    name="file2"> <input type="file" name="file3"></td>
                            </tr>
                            <input type="hidden" value=<%=sectionName %> name="sectionName" enctype="multipart/form-data">
                            <tr>
