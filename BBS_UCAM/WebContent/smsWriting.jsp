...
<body onload="loadJSON()">
   ...
   <div class="col-sm-4 list-group2">
          <div class="list-group list-group2">
            ...
            <% } else {%>	
            	<a href="ucammain.jsp" class="list-group-item">수강과목 조회</a>
          	<% } %>
          </div>
   </div><br><br>
   <br>
				...
				<tbody>
					<form method="post" name="smsForm" action="smssend.jsp">		
							...
							<td>	
								<div class="column -lefs=">
									<div class="form-group" style="text-align: left;">
										...
										<input type="checkbox" autocomplete="off" name=<%=list.get(i).getUserID()%> value=<%=list.get(i).getUserPhone()%>><%=list.get(i).getUserName()%>
										</label>
										<%
											}
										%>
						 ...
						 <tr>
        					...
        					<input type="hidden" name="sphone2" value="8078">
        					<input type="hidden" name="sphone3" value="5955">
						</tr>
						<tr>
							<th>내용:</th>
							 <td><textarea name="msg" cols="30" rows="10" style="width:455px;" placeholder="보낼 내용" class="form-control"></textarea></td>
						</tr>
