...
<nav class="navbar navbar-default"> <!-- navbar 클래스를 여기서 생성 -->
			<div class="navbar-header" style="background:#6f232f">
			<button type="button" class="navbar-toggle collapsed"
				data-toggle="collapse" style="color:white;" data-target="#bs-example-navbar-collapse-1"
				aria-expanded="false">
		...
		<div class="collapse navbar-collapse"
			id="bs-example-navbar-collapse-1" style="background:#6f232f">
	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px; background-color:rgb(232, 240, 254);">
