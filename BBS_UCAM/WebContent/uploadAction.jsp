...
<%@ page import="com.oreilly.servlet.multipart.DefaultFileRenamePolicy"%> <%-- DefaltFilerenamePlicy 파일이름이 같을 때 오류가 발생하지 않도록 하는  코드--%>
<%@ page import="com.oreilly.servlet.MultipartRequest"%> <%-- 파일 업로드를 수행할 수 있도록 도와줌 --%>
		...
		while(fileNames.hasMoreElements()) {
			...
			if(!fileName.endsWith(".doc") && !fileName.endsWith(".docx") && !fileName.endsWith(".hwp") &&
				...
				%></form>
						...
						<input type="hidden"  action="ucamsub.jsp" name="sectionName" value=<%=sectionName%>>
			...
			System.out.println("upload파일이름:"+fileRealName);
		}
