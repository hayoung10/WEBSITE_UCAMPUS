...
<%@ page import="java.util.ArrayList"%>
     ...
     */
     ...
     public static String base64Encode(String str)  throws java.io.IOException {
        //sun.misc.BASE64Encoder encoder = new sun.misc.BASE64Encoder();
         ...
         //return result ;
        byte[] strByte = str.getBytes();
         String strTxt=new String(strByte);
         String result = URLEncoder.encode(strTxt,"utf-8");
         return result ;
     }
    ...
    ==============================================================**/
    String charsetType = "utf-8"; //utf-8 또는 utf-8
    ...
    if(action.equals("go")) {
        ...
        String secure = base64Encode("####0123456789");//인증키
        ...
        for (int i = 0; i<list.size();i++){
        	if (list.get(i).getUserPhone().equals(request.getParameter(list.get(i).getUserID()))){
        		phonenum = phonenum + list.get(i).getUserPhone() + ",";
        	}
        }
